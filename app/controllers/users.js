...
exports.create = (req, res) => {
  ...
  if (!req.body.first_name) {
    ...
    return res.status(400).send({
      message:
        "Password field can not be empty, must be equal to or greater than 8 characters, must contain a lowercase letter at least, must contain an uppercase letter, must contain a number, must contain a special character(@#$%)"
    });
